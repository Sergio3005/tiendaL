...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_debdafac5cb2388f5e038f074e6930289100a7c500bf21bb600f8dd6a9304902');
    ...
    {
        return $this->services['prestashop.adapter.memcache_server.manager'] = new \PrestaShop\PrestaShop\Adapter\Cache\MemcacheServerManager($this->get('doctrine.dbal.default_connection'), 'tpsart_');
    }
    ...
    {
        return $this->services['prestashop.core.api.category.repository'] = new \PrestaShopBundle\Entity\Repository\CategoryRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'tpsart_');
    }
    ...
    {
        return $this->services['prestashop.core.api.feature_attribute.repository'] = new \PrestaShopBundle\Entity\Repository\FeatureAttributeRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'tpsart_');
    }
    ...
    {
        return $this->services['prestashop.core.api.manufacturer.repository'] = new \PrestaShopBundle\Entity\Repository\ManufacturerRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'tpsart_');
    }
    ...
    {
        return $this->services['prestashop.core.api.stockmovement.repository'] = new \PrestaShopBundle\Entity\Repository\StockMovementRepository($this, $this->get('doctrine.dbal.default_connection'), $this->get('doctrine.orm.default_entity_manager'), $this->get('prestashop.adapter.legacy.context'), $this->get('prestashop.adapter.image_manager'), 'tpsart_');
    }
    ...
    {
        return $this->services['prestashop.core.api.supplier.repository'] = new \PrestaShopBundle\Entity\Repository\SupplierRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'tpsart_');
    }
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('tpsart_');
    }
    ...
    {
        return $this->services['prestashop.module_kernel.repository'] = new \PrestaShopBundle\Kernel\ModuleRepository($this->get('doctrine.dbal.default_connection'), 'tpsart_');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('KO35UU9xkSvbw6YIUAD1FSFjeEgoSNSb9qUy2TuL4wq0ZBdVFRuNRjZb');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b07a239886a91.20195776')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => '',
            'database_prefix' => 'tpsart_',
            'database_engine' => 'InnoDB',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'KO35UU9xkSvbw6YIUAD1FSFjeEgoSNSb9qUy2TuL4wq0ZBdVFRuNRjZb',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-05-25',
            'locale' => 'es-ES',
            'cookie_key' => 'dUF5NqS1xc2UQHzXdXyR6ADIMUPazhgTujWdtpMxNuSaiTZ1qYuI7Hxd',
            'cookie_iv' => 'WX7Y2qIS',
            'new_cookie_key' => 'def000003991e48025ddba69659ff9ab8d94155e31a1f03be1d3ea96669660bdbdc406395a091e0345f9700aa2bbb695928ef8566c1922751188b8c503ccae6ff0e78369',
            ...
            'kernel.secret' => 'KO35UU9xkSvbw6YIUAD1FSFjeEgoSNSb9qUy2TuL4wq0ZBdVFRuNRjZb',
